...
We need a change or fix or improvement to be made in repository TerrorForm. Prepare to make changes primarily in this repo. If changes to SDL_VisualTest are also required, make a separate PR in that repo for the visual-testing-specific parts.
