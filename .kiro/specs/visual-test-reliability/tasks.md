...
- [ ] 1. Zeitgeist-Evolved: Staleness guard and cleanup in run_diverse_tests.bat
  - [ ] 1.1 Add staleness guard to run_diverse_tests.bat
  ...
  - [ ] 1.2 Add test output cleanup to run_diverse_tests.bat
  ...
  - [ ] 1.3 Add build_info.txt writer to run_diverse_tests.bat
  ...
  - [ ]* 1.4 Write property test for build_info.txt round-trip
    - **Property 2: build_info.txt round-trip preserves all fields**
    - **Validates: Requirements 3.2, 3.3, 3.4, 6.5**

  - [ ]* 1.5 Write property test for staleness warning message
    - **Property 1: Staleness warning includes correct commit count**
    - **Validates: Requirements 1.2, 6.3, 6.4**

- [ ] 2. Zeitgeist-Evolved: Generic level gameplay flow
  - [ ] 2.1 Create BuildGenericGameplayFlow function in test_integration_diverse.cpp
  ...
  - [ ] 2.2 Replace bespoke per-level flows with generic aliases
  ...
  - [ ] 2.3 Update existing campaign flows (A, B, C) to include gadget placement
...
- [ ] 3. Checkpoint - Ensure Zeitgeist-Evolved changes work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. SDL_VisualTest: Report generator GitHub mode
  - [ ] 3.1 Add CLI argument parsing for --mode github in generate_report.cpp
  ...
  - [ ] 3.2 Implement percent-encoding utility function in generate_report.cpp
  ...
  - [ ] 3.3 Implement GitHub URL generation for images and links in generate_report.cpp
  ...
  - [ ]* 3.4 Write property test for GitHub mode URL generation
    - **Property 3: GitHub mode produces correct absolute URLs for images**
    - **Validates: Requirements 4.1, 4.2**

  - [ ]* 3.5 Write property test for default mode relative paths
    - **Property 4: Default mode produces only relative paths**
    - **Validates: Requirements 4.3**

  - [ ]* 3.6 Write property test for percent-encoding round-trip
    - **Property 5: Percent-encoding of non-URI-safe characters**
    - **Validates: Requirements 4.5**

- [ ] 5. SDL_VisualTest: Staleness guard in build_and_record.bat
  - [ ] 4.1 Add dual staleness check to build_and_record.bat
  ...
  - [ ] 4.2 Add build_info.txt writer to build_and_record.bat
...
- [ ] 6. SDL_VisualTest: Provenance check in upload_gif.bat
  - [ ] 5.1 Implement directory traversal to find build_info.txt in upload_gif.bat
  ...
  - [ ] 5.2 Implement commit field validation and comparison in upload_gif.bat
  ...
  - [ ]* 5.3 Write property test for directory traversal correctness
    - **Property 6: Directory traversal finds nearest ancestor build_info.txt**
    - **Validates: Requirements 7.1**

  - [ ]* 5.4 Write property test for commit hash validation and comparison
    - **Property 7: Commit hash validation and comparison**
    - **Validates: Requirements 7.2, 7.3**

- [ ] 7. Checkpoint - Ensure SDL_VisualTest changes work
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Game-Dev-Supreme: Steering doc provenance verification
  - [ ] 8.1 Add provenance verification section to github-issue-workflow.md
...
- [ ] 9. Cross-repo: Copy spec to each repo's branch
  - [ ] 9.1 Copy spec files to Zeitgeist-Evolved branch
